...
class PluginService:
                ...
                try:
                    ...
                    for attr_name in dir(module):
                        ...
                        if (isinstance(attr, type) and 
                            issubclass(attr, FileSpecificRepair) and 
                            attr is not FileSpecificRepair):
    ...
    def load_plugin(
        self,
        plugin_class: Type[FileSpecificRepair],
        semi_automatic_solver: Any
        ...
        try:
            ...
            plugin_instance = plugin_class(
                semi_automatic_solver=semi_automatic_solver,
            ...
            if file_type is not None:
                try:
                    if not plugin.is_compatible(file_type):
                        logger.info(f"Plugin {plugin_name} not compatible with file type: {file_type}")
                        return False
                except Exception as e:
