...
def gen_app_layout(
    ...
    return html.Div(
        children=[
            ...
            html.H3(
                children="Possible invalid packets:", id="analyze-count-output", className="box"
            ),
            html.Div(
                [
                    dcc.Loading(
            ...
            html.Div(
                [
                    html.Button(
                        "Calculate rank of the LES", id="calculate-rank-button", className="button"
                    ),
                    html.Button("Reset chunk tag", id="reset-chunk-tag-button", className="button"),
                    html.Button(
                        "Calculate corrupt packet",
                        id="analyze-button",
                        n_clicks=0,
                        className="button",
                    ),
                    html.Button(
                        "Repair by exclusion",
                        id="repair-exclusion-button",
                        n_clicks=0,
                        className="button",
                    ),
                    html.Button(
                        "Find solutions by reordering",
                        id="repair-reorder-button",
                        n_clicks=0,
                        className="button",
                    ),
                    html.Button(
                    ...
                    html.Div(
                        [
                            html.Button(
                                "Tag affected chunks as invalid",
                                id="packet-tag-chunk-invalid-button",
                                className="button",
                            ),
                            html.Button(
                                "Tag affected chunks as valid",
                                id="packet-tag-chunk-valid-button",
                                className="button",
                            ),
                            dcc.Input(
                                id="packet-tag-chunk-input",
                                type="number",
                                className="input",
                    ...
                    html.Div(
                        [
                            ...
                            dcc.Input(
                                id="repair-id-input-box",
                                type="number",
                                min=0,
                                step=1,
                                max=len(max_chunk_tag),
                                className="input",
                    ...
                    html.Div(
                        [
                            dcc.Input(
                                id="hex-repair-input",
                                type="text",
                                placeholder="Hex to repair",
                                className="input",
                            ),
                            dcc.Input(
                                id="txt-repair-input",
                                type="text",
                                placeholder="Text to repair",
                                className="input",
                            ),
                            html.Button(
                                "Repair", id="repair-chunks-button", n_clicks=0, className="button"
                            ),
                        ],
                        hidden=True,
                        id="repair-input",
            ...
            html.Div(
                ...
                style=(
                    ...
                    if show_canvas
                    else {"image-rendering": "pixelated", "display": "none"}
                ),
                children=html.Div(
                    [
                        html.Div(
