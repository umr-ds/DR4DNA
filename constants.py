...
RANK_STATUS_PARTIAL_RECOVERY = (
    "augmented rank ({}) < number of chunks ({}), but partial recovery might be possible."
)
...
ERROR_CALCULATE_CORRUPT_PACKET_FIRST = (
    "Calculate the corrupt packet(s) using 'Find corrupt packet by shuffling' first."
)
...
ERROR_MULTIPLE_CORRUPT_PACKETS = (
    "Found multiple corrupt packets: {}. You might want to increase the number of permutations."
)
